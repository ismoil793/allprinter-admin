...
import UpdateAdcategory from "./UpdateCheckCategory";
...
class UpdateAdvert extends Component {
  ...
  componentWillMount() {
    if (this.props.location.ad_id !== undefined) {
      localStorage.setItem("ad_id", this.props.location.ad_id);
    }
  }
  ...
  SubmitHandler = e => {
    ...
    httpPost({
      url: `api/admin/ad/update/${localStorage.getItem("ad_id")}`,
      data: formData,
      headers: {
      ...
      .then(response => {
        notyf.success("Вы обновили рекламную компанию");
          ...
          <Col xs="12" md="12">
            <Card>
              <CardHeader>
                <Row>
                  <Col xs="12" md="2">
                    <strong>Обновить рекламную компанию</strong>
                  </Col>
                </Row>
              </CardHeader>
                    ...
                    <Row>
                      <Col md="12">
                        <FormGroup row>
                          ...
                          <Col md="9">
                            {/* <ParentCategory
                            checked={this.state.category_id}
                             
                            /> */}
                            <UpdateAdcategory  categoryFunction={this.categoryCallbackFunction}/>
                          </Col>
                        </FormGroup>
                      </Col>
                    </Row>
