...
const UpdateLink = props => (
  <>
<Link to={{pathname: `/delivery/carriercard/${props.courier_id}`, courier_id: props.courier_id}}>
<Button id="caret" color="info"> <i className="fa fa-eye"></i></Button>
</Link>
  </>
)

class CourierBtn extends Component {
  ...
  DeleteUser= (e) => {
    ...
    httpDelete({
      url: `api/admin/carrier/delete/${this.props.id}` 
    })
    .then(response => {
      ...
      <div className="animated fadeIn">
        <Row>
         ...
         <ButtonDropdown className="mr-1" isOpen={this.state.dropdownOpen[10]} toggle={() => { this.toggle(10); }}>
                 <UpdateLink courier_id={this.props.id}/>
