...
class SeoProduct extends Component {
  ...
  componentDidMount(){
    ...
    // }, 1000) 
      ...
      .then(response => {
        ...
        this.setState({
          meta_keywords_ru: response.data.data.meta_keywords ? response.data.data.meta_keywords.ru : null,
          meta_description_ru: response.data.data.meta_description.ru,
          meta_title_ru: response.data.data.meta_title.ru
        });
      })
      .catch(error => {
        console.log(error);
  ...
  updateProduct = e => {
    ...
    httpPost({
      ...
      data: {
        meta_title: {
          ru: this.state.meta_title_ru
        },
        meta_description: {
          ru: this.state.meta_description_ru
        },
        meta_keywords: {
          ru: this.state.meta_keywords_ru
        }
      }
    })
      .then(response => {
                  ...
                  <FormGroup row>
                    ...
                    <Col xs="12" md="9">
                      <Input
                        ...
                        id="text-input"
                        name="meta_title_ru"
                        value={this.state.meta_title_ru}
                  ...
                  <FormGroup row>
                    ...
                    <Col xs="12" md="9">
                      <Input
                        ...
                        value={this.state.meta_keywords_ru}
                        onChange={this.handleChange}
                        id="textarea-input"
                        rows="9"
