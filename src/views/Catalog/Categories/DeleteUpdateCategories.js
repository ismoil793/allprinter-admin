...
const UpdateLink = props => (
  <>
    <Link to={{pathname:`/catalog/updatecategory/${props.category_id}`, category_id: props.category_id}}>
...
U
  ...
  DeleteCategory= (e) => {
      ...
      httpDelete({
        url: `api/admin/category/delete/${this.props.id}` 
      })
      .then(response => {
      ...
      <div className="animated fadeIn">
        <Row>
         ...
         <ButtonDropdown className="mr-1" isOpen={this.state.dropdownOpen[10]} toggle={() => { this.toggle(10); }}>
                 <UpdateLink category_id={this.props.id} />
